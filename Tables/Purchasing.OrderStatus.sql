CREATE TABLE [Purchasing].[OrderStatus]
(
...
GO
ALTER TABLE [Purchasing].[OrderStatus] ADD CONSTRAINT [PK_OrderStatus_OrderStatusID] PRIMARY KEY CLUSTERED  ([OrderStatusID]) ON [PRIMARY]
GO
